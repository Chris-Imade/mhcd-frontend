  ...
  return (
    <div className='lg:flex items-center justify-between px-[62px] hidden'>
        <div className='flex items-center'>
            <div className='flex items-center justify-between w-[276.76px] h-[61.33px] px-[26px] bg-[#F2F1F8]'>
            ...
            <div className='lg:ml-[40px]'>
                <ul className='flex'>
                    <li><a className='mx-[9px]' href="#">Home</a></li>
                    <li><a className='mx-[9px]' href="#">About</a></li>
                    <li><a className='mx-[9px]' href="#">Course</a></li>
                    <li><a className='mx-[9px]' href="#">Partners</a></li>
                    <li><a className='mx-[9px]' href="#">Contact</a></li>
                </ul>
            </div>
        </div>
