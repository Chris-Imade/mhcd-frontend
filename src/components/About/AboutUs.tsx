  ...
  return (
    <div id='about' className='w-[100vw] lg:h-[752px] lg:py-[136px] py-[96px] flex-col lg:flex-row flex justify-center items-center'>
        ...
        <div className='lg:ml-[33px] mt-4 lg:mt-0'>
            ...
            <button className={`${styles.shadow} bg-[#EF6330] w-[174.45px] h-[49.3px] mt-[26px] text-white text-[22px] font-medium transition-all duration-500 ease-in-out hover:bg-white hover:text-[#46445C]`}>Start Now</button>
        </div>
    </div>
  )
}
